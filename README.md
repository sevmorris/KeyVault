...
<p align="center">
  ...
  <br />
  <a href="https://github.com/sevmorris/KeyVault/releases/latest/download/KeyVault-v1.2.3.dmg"><strong>Download Latest (DMG)</strong></a>
  ·
...
your login. That protects them from other people. It does not protect them from
a dead Mac, and Keychain items are local to one machine.
